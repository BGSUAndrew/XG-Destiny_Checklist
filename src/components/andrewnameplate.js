      ...
      const [seasonPass, setSeasonPass] = useState(0);
       ...
       useEffect(() => {
        const fetchData = async() => {
          const url = "https://www.bungie.net/Platform/Destiny2/1/Profile/4611686018430407175/?components=100,200,1400,202";
          ...
          getData.json().then(json => {
            console.log(json.Response.characterProgressions.data["2305843009263048442"]);
            setNameplate(json.Response.characters.data["2305843009263048442"].emblemBackgroundPath);
            ...
            setSeasonPass(json.Response.characterProgressions.data["2305843009263048442"].progressions["3733477714"].level)
          });
        }
        fetchData();
       },[]);
