...
class JoeActivity extends Component {
      ...
      async componentDidMount() {
        const url = "https://www.bungie.net/Platform/Destiny2/1/Account/4611686018518057094/Character/2305843009889894407/Stats/?modes=82,3,5,63";
      ...
      render() {
        ...
        {this.state.visible ?
            <div className='container'>
                                        <h1 id='joe' className='text-center'>Joe</h1>
