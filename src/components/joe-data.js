...
function JoeData() {
    ...
    useEffect(() => {
        const fetchData = async() => {
            const url = "https://www.bungie.net/Platform/Destiny2/1/Profile/4611686018518057094/?components=100,200,202";
            ...
            getData.json().then(json => {
                setPowerLevel(json.Response.characters.data["2305843009889894407"].light)
...
return (
    ...
    <div className="container" id="joe">
        <div className="card">
            <JoeName />
