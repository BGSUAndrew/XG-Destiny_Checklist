...
class JoeCommendationsData extends Component {
  ...
  async componentDidMount() {
    const url = "https://www.bungie.net/Platform/Destiny2/1/Profile/4611686018518057094/?components=1400";
...
export default JoeCommendationsData;