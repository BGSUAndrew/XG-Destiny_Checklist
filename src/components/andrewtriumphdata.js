...
class AndrewTriumphData extends Component {
  ...
  async componentDidMount() {
    ...
    this.setState({flawlessProgress: data.Response.profileRecords.data.records[3298130972].objectives[0].progress});
    this.setState({flawlessCompletion: data.Response.profileRecords.data.records[3298130972].objectives[0].completionValue});
    ...
    this.setState({praxicProgress: data.Response.characterRecords.data["2305843009263048442"].records[3779882910].objectives[0].progress});
    this.setState({praxicCompletionValue: data.Response.characterRecords.data["2305843009263048442"].records[3779882910].objectives[0].completionValue});
