...
class AndrewCommendationsData extends Component {
  ...
  async componentDidMount() {
    const url = "https://www.bungie.net/Platform/Destiny2/1/Profile/4611686018430407175/?components=1400";
...
export default AndrewCommendationsData;