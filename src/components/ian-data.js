...
function IanData() {
    ...
    useEffect(() => {
        const fetchData = async() => {
            const url = "https://www.bungie.net/Platform/Destiny2/1/Profile/4611686018519221998/?components=100,200,202";
            ...
            getData.json().then(json => {
                setPowerLevel(json.Response.characters.data["2305843009916944635"].light)
...
return (
    ...
    <div className="container" id="ian">
        <div className="card">
            <IanName />
